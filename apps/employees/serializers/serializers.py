...
from apps.assignments.serializers import EASSerializerSummary
from apps.departments.models import Department
from apps.departments.serializers import DepartmentSerializer
from apps.employees.models import Employee
from apps.employees.serializers.supervisor_serializers import SupervisorSerializer
...
class EmployeeSerializer(ModelSerializer):
    ...
    employee_assignments = EASSerializerSummary(many=True, read_only=True)
